...
public class GameApp {
	...
	private static void configureScene() throws OperationNotSupportedException {
		...
		//Create Mirror Mesh
		//		IEntity mirrorEntity = new Entity();
		//		transform = new Transform(mirrorEntity);
		//		transform.setLocalTranslate(Matrices.translation(0f, -1f, 0f));
		//		transform.setLocalRotate(Matrices.xRotation((float) (Math.PI / 2)));
		//		transform.setLocalScale(Matrices.scale(10f, 10f, 10f));
		//		IMeshDef mirrorMeshDef = new MeshDef();
		//		mirrorMeshDef.setPath(IOUtils.RES_FOLDER_PATH + "meshes\\square.mesh.csv");
		//		mirrorMeshDef.load();
		//		IMesh mirrorMesh = new Mesh(mirrorEntity, mirrorMeshDef);
		//		rootEntity.addChild(mirrorEntity);
		...
		//		mirrorMat.setVec3Param("mat_color", 1f, 1f, 1f);
		//		mirrorMesh.setMaterial(mirrorMat);
		//		IMirror mirror = new Mirror(mirrorEntity);
