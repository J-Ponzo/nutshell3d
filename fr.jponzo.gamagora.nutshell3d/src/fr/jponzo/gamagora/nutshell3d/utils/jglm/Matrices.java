 ...
 */
package fr.jponzo.gamagora.nutshell3d.utils.jglm;

import fr.jponzo.gamagora.nutshell3d.utils.jglm.support.FastMath;
...
public final class Matrices {
	...
	public static Mat4 xRotation(float teta) {
		Vec3 i = new Vec3(1f, 0f, 0f);
		return rotate(teta, i);
	}
	
	public static Mat4 yRotation(float teta) {
		Vec3 j = new Vec3(0f, 1f, 0f);
		return rotate(teta, j);
	}
	
	public static Mat4 zRotation(float teta) {
		Vec3 k = new Vec3(0f, 0f, 1f);
		return rotate(teta, k);
	}
	
	public static float[] flat(Mat4 matrix) {
		float[] floatBuffer = {
				((Vec4)matrix.getColumn(0)).getX(), ((Vec4)matrix.getColumn(0)).getY(), ((Vec4)matrix.getColumn(0)).getZ(), ((Vec4)matrix.getColumn(0)).getW(),
				((Vec4)matrix.getColumn(1)).getX(), ((Vec4)matrix.getColumn(1)).getY(), ((Vec4)matrix.getColumn(1)).getZ(), ((Vec4)matrix.getColumn(1)).getW(),
				((Vec4)matrix.getColumn(2)).getX(), ((Vec4)matrix.getColumn(2)).getY(), ((Vec4)matrix.getColumn(2)).getZ(), ((Vec4)matrix.getColumn(2)).getW(),
				((Vec4)matrix.getColumn(3)).getX(), ((Vec4)matrix.getColumn(3)).getY(), ((Vec4)matrix.getColumn(3)).getZ(), ((Vec4)matrix.getColumn(3)).getW(),
		};	
		return floatBuffer;
	}
}